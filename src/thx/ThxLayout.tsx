...
export const ThxLayout = () => {
  useTimeout(() => window.location.replace('alfabank://longread?endpoint=v1/adviser/longreads/15891'), 5000);
  return (
    <>
      ...
      <div className={appSt.bottomBtn}>
        <ButtonMobile block view="primary" href="alfabank://longread?endpoint=v1/adviser/longreads/15891">
